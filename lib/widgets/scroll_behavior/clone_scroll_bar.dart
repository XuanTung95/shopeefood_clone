...
class CustomScrollbarPainter extends ChangeNotifier implements CustomPainter {
  ...
  void _paintScrollbar(
    ...
    if (fadeoutOpacityAnimation.value != 0.0) {
      // Track
      final oldRect = _trackRect!;
      final newRect = Rect.fromCenter(center: oldRect.center, width: oldRect.width, height: oldRect.height - 1);
      canvas.drawRRect(RRect.fromRectAndRadius(newRect, radius ?? Radius.zero), _paintTrack());
      // Track Border
...
class CustomRawScrollbarState<T extends CustomRawScrollbar> extends State<T>
  ...
  /// theme.
  ///
  /// Defaults to false when [CustomRawScrollbar.isAlwaysShown] is null.
  ///
  /// See also:
  ///
  ///   * [CustomRawScrollbar.isAlwaysShown], which overrides the default behavior.
  @protected
